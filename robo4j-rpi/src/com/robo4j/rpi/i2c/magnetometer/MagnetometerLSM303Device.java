package com.robo4j.rpi.i2c.magnetometer;
...
public class MagnetometerDevice extends AbstractI2CDevice implements ReadableDevice<Float3D> {
	...
	public MagnetometerDevice() throws IOException {
		this(I2CBus.BUS_1, 0x1e, Mode.CONTINUOUS_CONVERSION, Rate.RATE_1_5, false);
	}

	public MagnetometerDevice(int bus, int address, Mode mode, Rate rate, boolean enableTemp) throws IOException {
		super(bus, address);
	...
	public enum Gain {
		GAIN_1_3(1.3f, 0x20, 1100, 980), GAIN_1_9(1.9f, 0x40, 855, 760), GAIN_2_5(2.5f, 0x60, 670, 600), GAIN_4_0(4.0f, 0x80, 450, 400), GAIN_4_7(
				4.7f, 0xA0, 400, 350), GAIN_5_6(5.6f, 0xC0, 330, 295), GAIN_8_1(8.1f, 0xE0, 230, 205);
	...
	public enum Rate {
		RATE_0_75(0.75f, 0x00), RATE_1_5(1.5f, 0x01), RATE_3_0(3.0f, 0x62), RATE_7_5(7.5f, 0x03), RATE_15(15f, 0x04), RATE_30(30f, 0x05), RATE_75(
				75f, 0x06), RATE_220(220f, 0x07);
